...
class UserWebcamPlayer:
    ...
    def _get_emotion(self, img) -> int:
        ...
        model = models.load_model('results/basic_model_10_epochs_timestamp_1708642612.keras')
    
        # replicate the grayscale image across 3 channels.
        img = np.repeat(img[..., np.newaxis], 3, axis=-1)  # Convert 2D grayscale to 3D RGB-like grayscale
